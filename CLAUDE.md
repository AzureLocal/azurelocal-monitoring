# azurelocal-monitoring — Claude Code Context
...
- `azurelocal-monitoring-engineer` (model: sonnet) — Expert in `azurelocal-monitoring`: deep knowledge of this repo's structure, conventions, and development workflow.
